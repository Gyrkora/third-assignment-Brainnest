...
//errors messages
const cancel =
	'Game canceled: If You decide to play the Game kindly refresh the page to begin';
const finish =
	'Game finished: If You decide to play the Game kindly refresh the page';
...
// This funtion takes return  the usersChoice with what happens when he decides to click okay or cancel
function userChoice() {
